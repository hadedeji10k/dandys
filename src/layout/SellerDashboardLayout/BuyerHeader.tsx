...
const SellerDashboardLayoutHeader2 = ({
  setSidebarIsOpen,
  sidebarIsOpen,
}: {
  ...
  return (
    <div className="w-full min-h-[100px] max-h-[100px] px-4 bg-shades-primary sticky top-0 flex flx-row items-center justify-between z-[1000]">
      ...
      <div className="hidden md:flex flex-row gap-x-8">
        <h3 className="text-[14px] font-bold text-shades-white cursor-pointer">
          HOME
        </h3>
        <h3 className="text-[14px] font-light text-shades-white cursor-pointer">
          ABOUT
        </h3>
        <h3 className="text-[14px] font-light text-shades-white cursor-pointer">
          CONTACT
      ...
      <div className="hidden md:flex flex-row gap-x-3 items-center">
        {isAuthenticated && user ? (
          <>
            <div className="rounded-[50%] px-3 py-4 bg-white/25 flex items-center justify-center">
              <Badge
                ...
                title="Notifications"
              >
                <BsHeart fill="white" className="text-[24px]" />
              </Badge>
            </div>
            <div className="rounded-[50%] px-3 py-4 bg-white/25 flex items-center justify-center">
              <Badge
                ...
                title="Notifications"
              >
                <FaCartShopping fill="white" className="text-[24px]" />
              </Badge>
            </div>
...
export default SellerDashboardLayoutHeader2;
